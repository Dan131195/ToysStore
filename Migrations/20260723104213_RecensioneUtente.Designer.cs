...
namespace ToysStore.Migrations
{
    ...
    [Migration("20260723104213_RecensioneUtente")]
    partial class RecensioneUtente
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ToysStore.Models.RecensioneUtente", b =>
                {
                    b.HasOne("ToysStore.Models.Utente", "Acquirente")
                        .WithMany("RecensioniScritte")
                    ...
                    b.HasOne("ToysStore.Models.Ordine", "Ordine")
                        .WithOne("Recensione")
                        .HasForeignKey("ToysStore.Models.RecensioneUtente", "OrdineId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ToysStore.Models.Utente", "Venditore")
                        .WithMany("RecensioniRicevute")
                        .HasForeignKey("VenditoreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ToysStore.Models.Utente", b =>
                {
                    ...
                    b.Navigation("RecensioniScritte");
                });
